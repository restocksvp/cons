...
export const ProgressViewModal = ({ onClose }) => {
        ...
        const calculateStats = () => {
            if (allRequests.length > 0) {
                ...
                for (const row of validRequests) {
                    ...
                    if (receiver && !senderStatsAgg[sender].styles_to_receivers[receiver]) {
            ...
            <div className="bg-gray-50 rounded-lg shadow-xl p-6 w-full max-w-6xl max-h-[90vh] flex flex-col" onClick={e => e.stopPropagation()}>
                ...
                {statusMessage ? (
                    ...
                    <div className="flex-grow overflow-y-auto space-y-6">
                        ...
                        <div>
                             {isStatsLoading ? <p>Loading Statistics...</p> : <StatisticsTable statsData={statsData} title="Saved Progress Statistics" />}
                        </div>
                    </div>
                )}
